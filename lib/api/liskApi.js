...
LiskAPI.prototype.listTransactionsPromise = function (address, limit, offset) {
	var that = this;
	return new Promise(function (resolve, reject) {
		that.listTransactions(address, limit, offset, function (data) {
			if (data.success) {
				resolve(data);
			}
			reject(data);
...
LiskAPI.prototype.sendLSKPromise = function (recipient, amount, passphrase, secondPassphrase) {
	var that = this;
	return new Promise(function (resolve, reject) {
		that.sendLSK(recipient, amount, passphrase, secondPassphrase, function (data) {
			if (data.success) {
				resolve(data);
			}
			reject(data);
